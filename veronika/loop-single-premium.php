    ...
    <div class="simple-wrap">
      ...
      <div class="item-img-wrap">
        <?php 
          ...
          $cat_icon = veronika_get_cat_icon(isset($root['pk_i_id']) ? $root['pk_i_id'] : null, true);
          if( $cat_icon <> '' ) {
            $icon = $cat_icon;
          } else {
        ...
        <?php if(osc_count_premium_resources()) { ?>
          <?php if(osc_count_premium_resources() == 1) { ?>
            <a class="img-link" href="<?php echo osc_premium_url(); ?>"><img class="lazyload" src="<?php echo veronika_resource_thumbnail_url(); ?>" data-src="<?php echo osc_resource_thumbnail_url(); ?>" title="<?php echo osc_esc_html(osc_premium_title()); ?>" alt="<?php echo osc_esc_html(osc_premium_title()); ?>" /></a>
          <?php } else { ?>
            <a class="img-link" href="<?php echo osc_premium_url(); ?>">
              <?php for ( $i = 0; osc_has_premium_resources(); $i++ ) { ?>
                <?php if($i <= 1) { ?>
                  <img class="lazyload link<?php echo $i; ?>" src="<?php echo veronika_resource_thumbnail_url(); ?>" data-src="<?php echo osc_resource_thumbnail_url(); ?>" title="<?php echo osc_esc_html(osc_premium_title()); ?>" alt="<?php echo osc_esc_html(osc_premium_title()); ?>" />
                <?php } ?>
              <?php } ?>
            </a>
          <?php } ?>
        <?php } else { ?>
          <a class="img-link" href="<?php echo osc_premium_url(); ?>"><img class="lazyload" src="<?php echo osc_current_web_theme_url('images/no-image.png'); ?>" data-src="<?php echo osc_current_web_theme_url('images/no-image.png'); ?>" title="<?php echo osc_esc_html(osc_premium_title()); ?>" alt="<?php echo osc_esc_html(osc_premium_title()); ?>" /></a>
        <?php } ?>
      ...
      <div class="price"><span><?php echo veronika_check_category_price(osc_premium_category_id()) ? veronika_premium_format_price(osc_premium_price()) : ''; ?></span></div>
    </div>
  </div>
  ...
  <div class="list-prod premium o<?php echo $c; ?><?php if($class <> '') { echo ' ' . $class; } ?> <?php osc_run_hook("highlight_class"); ?>">
    ...
    <div class="left">
      ...
      <?php if(osc_images_enabled_at_items() and osc_count_premium_resources() > 0) { ?>
        <a class="big-img" href="<?php echo osc_premium_url(); ?>"><img class="lazyload" src="<?php echo veronika_resource_thumbnail_url(); ?>" data-src="<?php echo osc_resource_thumbnail_url(); ?>" title="<?php echo osc_esc_html(osc_premium_title()); ?>" alt="<?php echo osc_esc_html(osc_premium_title()); ?>" /></a>

        <div class="img-bar">
          <?php osc_reset_resources(); ?>
          <?php for ( $i = 0; osc_has_premium_resources(); $i++ ) { ?>
            <?php if($i < 3 && osc_count_premium_resources() > 1) { ?>
              <span class="small-img<?php echo ($i==0 ? ' selected' : ''); ?>" id="bar_img_<?php echo $i; ?>"><img class="lazyload" src="<?php echo veronika_resource_thumbnail_url(); ?>" data-src="<?php echo osc_resource_thumbnail_url(); ?>" title="<?php echo osc_esc_html(osc_premium_title()); ?>" alt="<?php echo osc_esc_html(osc_premium_title()); ?>" /></span>
            <?php } ?>
          <?php } ?>
        </div>
      <?php } else { ?>
        <a class="big-img no-img" href="<?php echo osc_premium_url(); ?>"><img class="lazyload" src="<?php echo osc_current_web_theme_url('images/no-image.png'); ?>" data-original="<?php echo osc_current_web_theme_url('images/no-image.png'); ?>" title="<?php echo osc_esc_html(osc_premium_title()); ?>" alt="<?php echo osc_esc_html(osc_premium_title()); ?>" /></a>
      <?php } ?>
    </div>
    ...
    <div class="right">
      <div class="price"><?php echo veronika_check_category_price(osc_premium_category_id()) ? veronika_premium_format_price(osc_premium_price()) : ''; ?></div>
