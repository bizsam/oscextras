    ...
    <div class="left">
      ...
      <div class="about">
        ...
        <?php if(osc_get_preference('footer_link', 'veronika_theme')) { ?>
          <span class="powered">Powered by <a href="https://osclass.osclasspoint.com">best classifieds script</a> Osclass</span>
          <span class="created"><a href="https://osclasspoint.com">Osclass Themes</a></span>
        <?php } ?> 
