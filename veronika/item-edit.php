            ...
            <?php if(method_exists('ItemForm', 'show_phone_checkbox')) { ?>
              <div class="mail-show">
                <div class="input-box-check">
                  ...
                  <label for="showPhone" class="label-mail-show"><?php _e('Phone visible on ad', 'veronika'); ?></label>
                </div>
              </div>
            <?php } ?>
          </div>
          ...
          <div class="row user-email">
            ...
            <div class="mail-show">
              <div class="input-box-check">
                ...
                <label for="showEmail" class="label-mail-show"><?php _e('Email visible on ad', 'veronika'); ?></label>
              </div>
            </div>
          </div>
        </div>
