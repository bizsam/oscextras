...
<script type="text/javascript">
  ...
  var veronikaLazy = '<?php echo (osc_get_preference('force_aspect_image', 'osclass') <> 1 ? (osc_get_preference('lazyload', 'veronika_theme') == 1 ? 1 : 0) : 0); ?>';
...
osc_register_script('lazyload', 'https://cdnjs.cloudflare.com/ajax/libs/lazysizes/5.2.2/lazysizes.min.js');
...
if(osc_get_preference('force_aspect_image', 'osclass') <> 1 && osc_get_preference('lazyload', 'veronika_theme') == 1) {
  ...
  //osc_enqueue_script('lazyloadplugins');
}
