...
<body id="body-user-forgot-password">
  ...
  <h2><span><?php _e('Reset', 'veronika'); ?></span> <?php _e('password', 'veronika'); ?></h2>
  ...
  <div class="user_forms">
      <div class="inner">
        ...
        <fieldset>
          <div>
            <label for="new_email"><?php _e('New password', 'veronika') ; ?></label>
            <input type="password" name="new_password" value="" />
          </div>
          <div>
            <label for="new_email"><?php _e('Repeat password', 'veronika') ; ?></label>
            <input type="password" name="new_password2" value="" />
          </div>

          <button type="submit" id="blue"><?php _e('Submit', 'veronika') ; ?></button>
        </fieldset>
        </form>
      </div>
    </div>
