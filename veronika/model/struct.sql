DROP TABLE IF EXISTS /*TABLE_PREFIX*/t_item_veronika;
...
INSERT INTO /*TABLE_PREFIX*/t_item_veronika (fk_i_item_id) SELECT pk_i_id FROM /*TABLE_PREFIX*/t_item;

DROP TABLE IF EXISTS /*TABLE_PREFIX*/t_item_stats_veronika;
CREATE TABLE /*TABLE_PREFIX*/t_item_stats_veronika(
...
DROP TABLE IF EXISTS /*TABLE_PREFIX*/t_category_veronika;
CREATE TABLE /*TABLE_PREFIX*/t_category_veronika(
...
INSERT INTO /*TABLE_PREFIX*/t_category_veronika (fk_i_category_id) SELECT pk_i_id FROM /*TABLE_PREFIX*/t_category;
